...
#ifndef __CONFIG_AM335X_RSB4221A1_H
#define __CONFIG_AM335X_RSB4221A1_H

#if defined(CONFIG_TARGET_RSB4221A1_512M)
#define CONFIG_MEM_MICRON
#elif defined(CONFIG_TARGET_RSB4221A1_1G)
...
#define CONFIG_SYS_LDSCRIPT		"board/ti/am335x_adv/u-boot.lds"
#define CONFIG_SYS_BOARD_NAME		"rsb4221a1"
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"findfdt="\
		"if test $board_name = rsb4221a1; then " \
			"setenv fdtfile am335x-rsb4221a1.dtb; fi; " \
...
#define CONFIG_ENV_SPI_BUS		CONFIG_MAC_ADDR_SPI_BUS
#define CONFIG_ENV_SPI_CS		CONFIG_MAC_ADDR_SPI_CS
#define CONFIG_ENV_SPI_MODE		CONFIG_MAC_ADDR_SPI_MODE
#define CONFIG_SYS_REDUNDAND_ENVIRONMENT
#define CONFIG_ENV_SPI_MAX_HZ           CONFIG_SF_DEFAULT_SPEED
#define CONFIG_ENV_SECT_SIZE            (4 << 10) /* 4 KB sectors */
#define CONFIG_ENV_OFFSET               (768 << 10) /* 768 KiB in */
...
#endif	/* ! __CONFIG_AM335X_RSB4221A1_H */
