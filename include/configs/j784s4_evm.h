...
#define EXTRA_ENV_CONFIG_MAIN_CPSW0_QSGMII_PHY				\
	...
	"toggle_mux2_ethfw=gpio set gpio@22_13; gpio set gpio@22_14;"	\
			   "gpio set gpio@22_15\0"			\
	"main_cpsw0_qsgmii_phyinit="					\
	"if test ${do_main_cpsw0_qsgmii_phyinit} -eq 1 && test ${dorprocboot} -eq 1 && " \
			"test ${boot} = mmc; then "			\
		"run init_main_cpsw0_qsgmii_phy; run toggle_mux2_ethfw;"\
	"fi;\0"
...
/* TODO : Change the default rprocs to reflect j784s4 */
