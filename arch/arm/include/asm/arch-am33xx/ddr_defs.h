...
#else
/*######################################################*/
/*###########  Advantech platform DDR  Timing   ########*/
/*######################################################*/
/*
* We use the MT41J512M8RH125_xx macro for all kinds of
* DDR3.
*/
/* SAMSUNG DDR */
#if defined (CONFIG_MEM_SAMSUNG)
#define MT41J512M8RH125_EMIF_READ_LATENCY	0x07
#define MT41J512M8RH125_EMIF_TIM1		0x0AAAE51B
#define MT41J512M8RH125_EMIF_TIM2		0x26437FDA
#define MT41J512M8RH125_EMIF_TIM3		0x501F83FF
#define MT41J512M8RH125_EMIF_SDCFG		0x61C05332
#define MT41J512M8RH125_EMIF_SDREF		0x00000C30
#define MT41J512M8RH125_ZQ_CFG			0x50074BE4
#define MT41J512M8RH125_RATIO			0x80
#define MT41J512M8RH125_INVERT_CLKOUT		0x0
#ifdef CONFIG_TARGET_RSB4220A1_512M
#define MT41J512M8RH125_RD_DQS			0x37
#define MT41J512M8RH125_WR_DQS			0x41
#define MT41J512M8RH125_PHY_FIFO_WE		0xB4
#define MT41J512M8RH125_PHY_WR_DATA		0x79
#endif
#ifdef CONFIG_TARGET_ROM3310A1_512M
#define MT41J512M8RH125_RD_DQS			0x37
#define MT41J512M8RH125_WR_DQS			0x5A
#define MT41J512M8RH125_PHY_FIFO_WE		0xAC
#define MT41J512M8RH125_PHY_WR_DATA		0x93
#endif
#define MT41J512M8RH125_IOCTRL_VALUE		0x18B
/*END OF CONFIG_MEM_SAMSUNG*/
#elif defined (CONFIG_MEM_MICRON)
/* MICRON DDR */
#define MT41J512M8RH125_EMIF_READ_LATENCY	0x07
#define MT41J512M8RH125_EMIF_SDREF		0x00000C30
#define MT41J512M8RH125_ZQ_CFG			0x50074BE4
...
#define MT41J512M8RH125_INVERT_CLKOUT		0x0
#ifdef CONFIG_TARGET_ROM3310A1_512M
#define MT41J512M8RH125_EMIF_TIM1		0x0AAAD4DB
#define MT41J512M8RH125_EMIF_TIM2		0x2A437FDA
#define MT41J512M8RH125_EMIF_TIM3		0x501F83FF
#define MT41J512M8RH125_EMIF_SDCFG		0x61C05332
#define MT41J512M8RH125_RD_DQS			0x3A
#define MT41J512M8RH125_WR_DQS			0x5D
#define MT41J512M8RH125_PHY_FIFO_WE		0xAF
#define MT41J512M8RH125_PHY_WR_DATA		0x9A
#endif
#ifdef 	CONFIG_TARGET_RSB4220A1_512M
#define MT41J512M8RH125_EMIF_TIM1		0x0AAAD4DB
#define MT41J512M8RH125_EMIF_TIM2		0x2A437FDA
...
#define MT41J512M8RH125_EMIF_SDCFG		0x61C05332
#define MT41J512M8RH125_RD_DQS			0x3B
#define MT41J512M8RH125_WR_DQS			0x4A
#define MT41J512M8RH125_PHY_FIFO_WE		0xB9
#define MT41J512M8RH125_PHY_WR_DATA		0x84
#endif
#ifdef 	CONFIG_TARGET_RSB4221A1_512M
#define MT41J512M8RH125_EMIF_TIM1		0x0AAAE51B
#define MT41J512M8RH125_EMIF_TIM2		0x26437FDA
#define MT41J512M8RH125_EMIF_TIM3		0x501F83FF
#define MT41J512M8RH125_EMIF_SDCFG		0x61C05332
#define MT41J512M8RH125_RD_DQS			0x39
#define MT41J512M8RH125_WR_DQS			0x42
#define MT41J512M8RH125_PHY_FIFO_WE		0xB7
#define MT41J512M8RH125_PHY_WR_DATA		0x7D
#endif
#define MT41J512M8RH125_IOCTRL_VALUE		0x18B
/* END OF CONFIG_MEM_MICRON */
#elif (defined CONFIG_MEM_MICRON_1G)
#define MT41J512M8RH125_EMIF_SDREF		0x00000C30
#define MT41J512M8RH125_ZQ_CFG			0x50074BE4
#define MT41J512M8RH125_DLL_LOCK_DIFF		0x1
#define MT41J512M8RH125_RATIO			0x80
#define MT41J512M8RH125_INVERT_CLKOUT		0x0
#ifdef CONFIG_TARGET_RSB4220A1_1G
#define MT41J512M8RH125_EMIF_READ_LATENCY	0x0D
#define MT41J512M8RH125_EMIF_TIM1		0x199DDAA3
#define MT41J512M8RH125_EMIF_TIM2		0x2CFC7FDA
#define MT41J512M8RH125_EMIF_TIM3		0x501F8F2F
#define MT41J512M8RH125_EMIF_SDCFG		0x61C053B2
#define MT41J512M8RH125_RD_DQS			0x3C
#define MT41J512M8RH125_WR_DQS			0x55
#define MT41J512M8RH125_PHY_FIFO_WE		0xB6
#define MT41J512M8RH125_PHY_WR_DATA		0x91
#endif
#ifdef CONFIG_TARGET_RSB4221A1_1G
#define MT41J512M8RH125_EMIF_READ_LATENCY	0x07
#define MT41J512M8RH125_EMIF_TIM1		0x0AAAD4DB
#define MT41J512M8RH125_EMIF_TIM2		0x2A6B7FDA
#define MT41J512M8RH125_EMIF_TIM3		0x501F867F
#define MT41J512M8RH125_EMIF_SDCFG		0x61C053B2
#define MT41J512M8RH125_RD_DQS			0x3A
#define MT41J512M8RH125_WR_DQS			0x50
#define MT41J512M8RH125_PHY_FIFO_WE		0xB4
#define MT41J512M8RH125_PHY_WR_DATA		0x8D
#endif
#ifdef CONFIG_TARGET_EPCR3220A1_1G
#define MT41J512M8RH125_EMIF_READ_LATENCY	0x07
#define MT41J512M8RH125_EMIF_TIM1		0x0AAAD4DB
#define MT41J512M8RH125_EMIF_TIM2		0x2A6B7FDA
#define MT41J512M8RH125_EMIF_TIM3		0x501F867F
...
#define MT41J512M8RH125_RD_DQS			0x39
#define MT41J512M8RH125_WR_DQS			0x3C
#define MT41J512M8RH125_PHY_FIFO_WE		0xA1
#define MT41J512M8RH125_PHY_WR_DATA		0x77
/*
#define MT41J512M8RH125_EMIF_READ_LATENCY       0x07
#define MT41J512M8RH125_EMIF_TIM1               0x0AAAC463
#define MT41J512M8RH125_EMIF_TIM2               0x2C6B7FDA
#define MT41J512M8RH125_EMIF_TIM3               0x501F867F
#define MT41J512M8RH125_EMIF_SDCFG              0x61C053B2
#define MT41J512M8RH125_RD_DQS                  0x39
#define MT41J512M8RH125_WR_DQS                  0xA2
#define MT41J512M8RH125_PHY_FIFO_WE             0x3C
#define MT41J512M8RH125_PHY_WR_DATA             0x77
*/
#endif
#define MT41J512M8RH125_IOCTRL_VALUE		0x18B
