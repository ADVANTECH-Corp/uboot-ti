...
MAX_SIZE= $(shell printf "%d" $(CONFIG_MAX_DOWNLODABLE_IMAGE_SIZE))
...
SED_OPTS+= -e s/TEST_BOOT_CORE/$(CONFIG_K3_BOOT_CORE_ID)/
...
cmd_gencert = cat $(srctree)/tools/k3/x509template.txt | sed $(SED_OPTS) > u-boot-spl-x509.txt; \
